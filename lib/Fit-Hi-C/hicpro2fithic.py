...
if __name__=="__main__":
	...
	parser.add_argument("-n", "--prefix", help="Prefix name of file", default=True)
	...
	icounts_output = os.path.join(args.output + "/" + args.prefix + ".fithic.interactionCounts.gz")
	fragmap_output = os.path.join(args.output + "/" + args.prefix + ".fithic.fragmentMappability.gz")
	bias_output = None
